<%-- 
    Document   : quiz
    Created on : Feb 12, 2012, 7:20:58 PM
    Author     : kiruba Nandhan
--%>
...
<html>
    <head>
        ...
        var sessionTimeout = 60;	           // NO of seconds given to complete test
        ...
        var milisec=0 
        var seconds=1					//Displays the timer
        document.form1.d2.value='1'      //Displays the timer
    ...
    <center><form name="form1" action="<%=request.getContextPath()%>/Accenture_exam" method="post">
            <font size="10">
