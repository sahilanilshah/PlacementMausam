...
<script>
function myFunction() {
    window.open("mock1_paper_quants.jsp","_self","channelmode=yes","fullscreen=yes");
}
</script>
...
<h4 class="ex1">2.	Within 20 minutes you have to answer the quesions, Otherwise the session will be expired.</h4>
   <h4 class="ex1">3. There are no negative marks for the wrong answers.</h4>
     ...
     <button class="btn mybtn-primary btn-xl page-scroll" onclick="myFunction();">Start Quantitative Section          
     </button>        
